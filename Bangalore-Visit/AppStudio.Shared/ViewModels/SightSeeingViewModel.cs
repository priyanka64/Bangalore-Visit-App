...
{
    public class SightSeeingViewModel : ViewModelBase<HtmlSchema>
    {
        ...
        {
            return new SightSeeingDataSource(); // HtmlDataSource
        }
        ...
        {
            base.PinToStart("MainPage", @"Sight Seeing", "{Content}", "");
        }
