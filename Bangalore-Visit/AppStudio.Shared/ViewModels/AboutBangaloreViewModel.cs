...
{
    public class AboutBangaloreViewModel : ViewModelBase<HtmlSchema>
    {
        ...
        {
            return new AboutBangaloreDataSource(); // HtmlDataSource
        }
        ...
        {
            base.PinToStart("MainPage", @"About Bangalore", "{Content}", "");
        }
