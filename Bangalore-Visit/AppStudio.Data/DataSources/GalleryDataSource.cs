...
{
    public class GalleryDataSource : DataSourceBase<HtmlSchema>
    {
        private const string HtmlSource = "/Assets/Data/GalleryDataSource.htm";
        ...
        public async override Task<IEnumerable<HtmlSchema>> LoadDataAsync()
        {
            ...
            {
                AppLogs.WriteError("GalleryDataSource.LoadData", ex.ToString());
